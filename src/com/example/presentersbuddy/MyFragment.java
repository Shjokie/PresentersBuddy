...
import com.example.presentersbuddy.R.color;
...
public class MyFragment extends Fragment {
	...
	public static final MyFragment newInstance(String i) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		notes.setHintTextColor(color.tranwhite);
		title.setHintTextColor(color.tranblack);

		title.setTypeface(face);
		notes.setTypeface(face2);
